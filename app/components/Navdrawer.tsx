...
/* ── Logo SVG sama dengan Navbar ── */
const LogoIcon = () => (
  <svg width="80" height="26" viewBox="0 0 90 29" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function NavDrawer({ isOpen, onClose }: NavDrawerProps) {
  ...
  return (
    <>
      {/* Overlay — hanya gunakan CSS class, tanpa inline style */}
      <div
      ...
      <div className={`nav-drawer${isOpen ? ' show' : ''}`}>
        {/* Header — logo konsisten dengan Navbar */}
        <div className="drawer-header">
          <div className="drawer-brand">
            <LogoIcon />
          </div>
          <div className="drawer-close" onClick={onClose} role="button" aria-label="Tutup menu">
        ...
        {/* Data Reklame accordion — sinkron dengan desktop */}
        <div
        ...
        <div className={`drawer-sub${asetOpen ? ' open' : ''}`}>
          <Link className="drawer-sub-item" href="/manajemen_reklame" onClick={onClose}>
        ...
        {/* User section — dengan Ubah Password & Logout */}
        <div className="drawer-user-actions">
          ...
          <Link href="/ubah_password" className="drawer-action-item" onClick={onClose}>
            <svg viewBox="0 0 24 24">
          ...
          <button className="drawer-action-item drawer-action-danger" onClick={handleLogout}>
            <svg viewBox="0 0 24 24">
